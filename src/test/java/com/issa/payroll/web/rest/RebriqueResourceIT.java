...
class RebriqueResourceIT {
    ...
    private static final Boolean DEFAULT_IN_BP = false;
    private static final Boolean UPDATED_IN_BP = true;
    ...
    void createRebrique() throws Exception {
        ...
        assertThat(testRebrique.getInSocial()).isEqualTo(DEFAULT_IN_SOCIAL);
        assertThat(testRebrique.getInBp()).isEqualTo(DEFAULT_IN_BP);
        assertThat(testRebrique.getVal()).isEqualTo(DEFAULT_VAL);
    ...
    void getAllRebriques() throws Exception {
        ...
        restRebriqueMockMvc
            ...
            .andExpect(jsonPath("$.[*].inBp").value(hasItem(DEFAULT_IN_BP.booleanValue())))
    ...
    void getRebrique() throws Exception {
        ...
        restRebriqueMockMvc
            ...
            .andExpect(jsonPath("$.inBp").value(DEFAULT_IN_BP.booleanValue()))
    ...
    void putNewRebrique() throws Exception {
        ...
        assertThat(testRebrique.getInSocial()).isEqualTo(UPDATED_IN_SOCIAL);
        assertThat(testRebrique.getInBp()).isEqualTo(UPDATED_IN_BP);
        assertThat(testRebrique.getVal()).isEqualTo(UPDATED_VAL);
