...
class PayrollResourceIT {
    ...
    private static final Integer DEFAULT_NB_FULL_PAIE = 1;
    private static final Integer UPDATED_NB_FULL_PAIE = 2;

    private static final Integer DEFAULT_NB_HALF_PAIE = 1;
    private static final Integer UPDATED_NB_HALF_PAIE = 2;

    private static final Integer DEFAULT_NB_NON_PAIE = 1;
    private static final Integer UPDATED_NB_NON_PAIE = 2;
    ...
    private static final Double DEFAULT_TOTAL_COTIS = 1D;
    private static final Double UPDATED_TOTAL_COTIS = 2D;

    private static final Double DEFAULT_TOTAL_RETENUE = 1D;
    private static final Double UPDATED_TOTAL_RETENUE = 2D;

    private static final Double DEFAULT_TOTAL_TAXABLE = 1D;
    private static final Double UPDATED_TOTAL_TAXABLE = 2D;
    ...
    public static Payroll createEntity(EntityManager em) {
        Payroll payroll = new Payroll()
            ...
            .annee(DEFAULT_ANNEE)
            .mois(DEFAULT_MOIS)
            .nbFullPaie(DEFAULT_NB_FULL_PAIE)
            .nbHalfPaie(DEFAULT_NB_HALF_PAIE)
            .nbNonPaie(DEFAULT_NB_NON_PAIE)
            .dateCalcul(DEFAULT_DATE_CALCUL)
            .dateValid(DEFAULT_DATE_VALID)
            .datePayroll(DEFAULT_DATE_PAYROLL)
            .totalCotis(DEFAULT_TOTAL_COTIS)
            .totalRetenue(DEFAULT_TOTAL_RETENUE)
            .totalTaxable(DEFAULT_TOTAL_TAXABLE)
    ...
    public static Payroll createUpdatedEntity(EntityManager em) {
        Payroll payroll = new Payroll()
            ...
            .annee(UPDATED_ANNEE)
            .mois(UPDATED_MOIS)
            .nbFullPaie(UPDATED_NB_FULL_PAIE)
            .nbHalfPaie(UPDATED_NB_HALF_PAIE)
            .nbNonPaie(UPDATED_NB_NON_PAIE)
            .dateCalcul(UPDATED_DATE_CALCUL)
            .dateValid(UPDATED_DATE_VALID)
            .datePayroll(UPDATED_DATE_PAYROLL)
            .totalCotis(UPDATED_TOTAL_COTIS)
            .totalRetenue(UPDATED_TOTAL_RETENUE)
            .totalTaxable(UPDATED_TOTAL_TAXABLE)
    ...
    void createPayroll() throws Exception {
        ...
        assertThat(testPayroll.getNbFullPaie()).isEqualTo(DEFAULT_NB_FULL_PAIE);
        assertThat(testPayroll.getNbHalfPaie()).isEqualTo(DEFAULT_NB_HALF_PAIE);
        assertThat(testPayroll.getNbNonPaie()).isEqualTo(DEFAULT_NB_NON_PAIE);
        ...
        assertThat(testPayroll.getTotalCotis()).isEqualTo(DEFAULT_TOTAL_COTIS);
        assertThat(testPayroll.getTotalRetenue()).isEqualTo(DEFAULT_TOTAL_RETENUE);
        assertThat(testPayroll.getTotalTaxable()).isEqualTo(DEFAULT_TOTAL_TAXABLE);
    ...
    void getAllPayrolls() throws Exception {
        ...
        restPayrollMockMvc
            ...
            .andExpect(jsonPath("$.[*].nbFullPaie").value(hasItem(DEFAULT_NB_FULL_PAIE)))
            .andExpect(jsonPath("$.[*].nbHalfPaie").value(hasItem(DEFAULT_NB_HALF_PAIE)))
            .andExpect(jsonPath("$.[*].nbNonPaie").value(hasItem(DEFAULT_NB_NON_PAIE)))
            ...
            .andExpect(jsonPath("$.[*].totalCotis").value(hasItem(DEFAULT_TOTAL_COTIS.doubleValue())))
            .andExpect(jsonPath("$.[*].totalRetenue").value(hasItem(DEFAULT_TOTAL_RETENUE.doubleValue())))
            .andExpect(jsonPath("$.[*].totalTaxable").value(hasItem(DEFAULT_TOTAL_TAXABLE.doubleValue())))
    ...
    void getPayroll() throws Exception {
        ...
        restPayrollMockMvc
            ...
            .andExpect(jsonPath("$.nbFullPaie").value(DEFAULT_NB_FULL_PAIE))
            .andExpect(jsonPath("$.nbHalfPaie").value(DEFAULT_NB_HALF_PAIE))
            .andExpect(jsonPath("$.nbNonPaie").value(DEFAULT_NB_NON_PAIE))
            ...
            .andExpect(jsonPath("$.totalCotis").value(DEFAULT_TOTAL_COTIS.doubleValue()))
            .andExpect(jsonPath("$.totalRetenue").value(DEFAULT_TOTAL_RETENUE.doubleValue()))
            .andExpect(jsonPath("$.totalTaxable").value(DEFAULT_TOTAL_TAXABLE.doubleValue()))
    ...
    void putNewPayroll() throws Exception {
        ...
        assertThat(testPayroll.getNbFullPaie()).isEqualTo(UPDATED_NB_FULL_PAIE);
        assertThat(testPayroll.getNbHalfPaie()).isEqualTo(UPDATED_NB_HALF_PAIE);
        assertThat(testPayroll.getNbNonPaie()).isEqualTo(UPDATED_NB_NON_PAIE);
        ...
        assertThat(testPayroll.getTotalCotis()).isEqualTo(UPDATED_TOTAL_COTIS);
        assertThat(testPayroll.getTotalRetenue()).isEqualTo(UPDATED_TOTAL_RETENUE);
        assertThat(testPayroll.getTotalTaxable()).isEqualTo(UPDATED_TOTAL_TAXABLE);
