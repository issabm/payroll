...
class NatureAbsenceResourceIT {
    ...
    void createNatureAbsence() throws Exception {
        ...
        assertThat(testNatureAbsence.getFullPay()).isEqualTo(DEFAULT_FULL_PAY);
        assertThat(testNatureAbsence.getHalfPay()).isEqualTo(DEFAULT_HALF_PAY);
    ...
    void putNewNatureAbsence() throws Exception {
        ...
        assertThat(testNatureAbsence.getFullPay()).isEqualTo(UPDATED_FULL_PAY);
        assertThat(testNatureAbsence.getHalfPay()).isEqualTo(UPDATED_HALF_PAY);
