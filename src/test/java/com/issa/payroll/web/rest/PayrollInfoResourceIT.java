...
class PayrollInfoResourceIT {
    ...
    private static final Double DEFAULT_CALCUL_VAL = 1D;
    private static final Double UPDATED_CALCUL_VAL = 2D;

    private static final Double DEFAULT_EFFECT_VAL = 1D;
    private static final Double UPDATED_EFFECT_VAL = 2D;

    private static final Double DEFAULT_TAUX_ABS = 1D;
    private static final Double UPDATED_TAUX_ABS = 2D;

    private static final Double DEFAULT_FINAL_VAL = 1D;
    private static final Double UPDATED_FINAL_VAL = 2D;

    private static final Double DEFAULT_EFFECT_VAL_DEVISE = 1D;
    private static final Double UPDATED_EFFECT_VAL_DEVISE = 2D;
    ...
    public static PayrollInfo createEntity(EntityManager em) {
        PayrollInfo payrollInfo = new PayrollInfo()
            ...
            .calculVal(DEFAULT_CALCUL_VAL)
            .effectVal(DEFAULT_EFFECT_VAL)
            .tauxAbs(DEFAULT_TAUX_ABS)
            .finalVal(DEFAULT_FINAL_VAL)
            .effectValDevise(DEFAULT_EFFECT_VAL_DEVISE)
    ...
    public static PayrollInfo createUpdatedEntity(EntityManager em) {
        PayrollInfo payrollInfo = new PayrollInfo()
            ...
            .calculVal(UPDATED_CALCUL_VAL)
            .effectVal(UPDATED_EFFECT_VAL)
            .tauxAbs(UPDATED_TAUX_ABS)
            .finalVal(UPDATED_FINAL_VAL)
            .effectValDevise(UPDATED_EFFECT_VAL_DEVISE)
    ...
    void createPayrollInfo() throws Exception {
        ...
        assertThat(testPayrollInfo.getCalculVal()).isEqualTo(DEFAULT_CALCUL_VAL);
        assertThat(testPayrollInfo.getEffectVal()).isEqualTo(DEFAULT_EFFECT_VAL);
        assertThat(testPayrollInfo.getTauxAbs()).isEqualTo(DEFAULT_TAUX_ABS);
        assertThat(testPayrollInfo.getFinalVal()).isEqualTo(DEFAULT_FINAL_VAL);
        assertThat(testPayrollInfo.getEffectValDevise()).isEqualTo(DEFAULT_EFFECT_VAL_DEVISE);
    ...
    void getAllPayrollInfos() throws Exception {
        ...
        restPayrollInfoMockMvc
            ...
            .andExpect(jsonPath("$.[*].calculVal").value(hasItem(DEFAULT_CALCUL_VAL.doubleValue())))
            .andExpect(jsonPath("$.[*].effectVal").value(hasItem(DEFAULT_EFFECT_VAL.doubleValue())))
            .andExpect(jsonPath("$.[*].tauxAbs").value(hasItem(DEFAULT_TAUX_ABS.doubleValue())))
            .andExpect(jsonPath("$.[*].finalVal").value(hasItem(DEFAULT_FINAL_VAL.doubleValue())))
            .andExpect(jsonPath("$.[*].effectValDevise").value(hasItem(DEFAULT_EFFECT_VAL_DEVISE.doubleValue())))
    ...
    void getPayrollInfo() throws Exception {
        ...
        restPayrollInfoMockMvc
            ...
            .andExpect(jsonPath("$.calculVal").value(DEFAULT_CALCUL_VAL.doubleValue()))
            .andExpect(jsonPath("$.effectVal").value(DEFAULT_EFFECT_VAL.doubleValue()))
            .andExpect(jsonPath("$.tauxAbs").value(DEFAULT_TAUX_ABS.doubleValue()))
            .andExpect(jsonPath("$.finalVal").value(DEFAULT_FINAL_VAL.doubleValue()))
            .andExpect(jsonPath("$.effectValDevise").value(DEFAULT_EFFECT_VAL_DEVISE.doubleValue()))
    ...
    void putNewPayrollInfo() throws Exception {
        ...
        assertThat(testPayrollInfo.getCalculVal()).isEqualTo(UPDATED_CALCUL_VAL);
        assertThat(testPayrollInfo.getEffectVal()).isEqualTo(UPDATED_EFFECT_VAL);
        assertThat(testPayrollInfo.getTauxAbs()).isEqualTo(UPDATED_TAUX_ABS);
        assertThat(testPayrollInfo.getFinalVal()).isEqualTo(UPDATED_FINAL_VAL);
        assertThat(testPayrollInfo.getEffectValDevise()).isEqualTo(UPDATED_EFFECT_VAL_DEVISE);
