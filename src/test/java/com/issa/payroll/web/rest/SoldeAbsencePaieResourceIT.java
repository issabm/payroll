...
class SoldeAbsencePaieResourceIT {
    ...
    void createSoldeAbsencePaie() throws Exception {
        ...
        assertThat(testSoldeAbsencePaie.getFullPayRight()).isEqualTo(DEFAULT_FULL_PAY_RIGHT);
        assertThat(testSoldeAbsencePaie.getHalfPayRight()).isEqualTo(DEFAULT_HALF_PAY_RIGHT);
        assertThat(testSoldeAbsencePaie.getFullPay()).isEqualTo(DEFAULT_FULL_PAY);
        assertThat(testSoldeAbsencePaie.getHalfPay()).isEqualTo(DEFAULT_HALF_PAY);
    ...
    void putNewSoldeAbsencePaie() throws Exception {
        ...
        assertThat(testSoldeAbsencePaie.getFullPayRight()).isEqualTo(UPDATED_FULL_PAY_RIGHT);
        assertThat(testSoldeAbsencePaie.getHalfPayRight()).isEqualTo(UPDATED_HALF_PAY_RIGHT);
        assertThat(testSoldeAbsencePaie.getFullPay()).isEqualTo(UPDATED_FULL_PAY);
        assertThat(testSoldeAbsencePaie.getHalfPay()).isEqualTo(UPDATED_HALF_PAY);
