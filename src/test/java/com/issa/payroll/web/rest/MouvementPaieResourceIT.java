...
class MouvementPaieResourceIT {
    ...
    void createMouvementPaie() throws Exception {
        ...
        assertThat(testMouvementPaie.getTotalCotis()).isEqualTo(DEFAULT_TOTAL_COTIS);
        assertThat(testMouvementPaie.getTotalRetenue()).isEqualTo(DEFAULT_TOTAL_RETENUE);
        assertThat(testMouvementPaie.getTotalTaxable()).isEqualTo(DEFAULT_TOTAL_TAXABLE);
        assertThat(testMouvementPaie.getTotalTax()).isEqualTo(DEFAULT_TOTAL_TAX);
    ...
    void putNewMouvementPaie() throws Exception {
        ...
        assertThat(testMouvementPaie.getTotalCotis()).isEqualTo(UPDATED_TOTAL_COTIS);
        assertThat(testMouvementPaie.getTotalRetenue()).isEqualTo(UPDATED_TOTAL_RETENUE);
        assertThat(testMouvementPaie.getTotalTaxable()).isEqualTo(UPDATED_TOTAL_TAXABLE);
        assertThat(testMouvementPaie.getTotalTax()).isEqualTo(UPDATED_TOTAL_TAX);
