...
class SoldeAbsenceResourceIT {
    ...
    private static final Integer DEFAULT_FULL_PAY = 1;
    private static final Integer UPDATED_FULL_PAY = 2;

    private static final Integer DEFAULT_HALF_PAY = 1;
    private static final Integer UPDATED_HALF_PAY = 2;
    ...
    public static SoldeAbsence createEntity(EntityManager em) {
        SoldeAbsence soldeAbsence = new SoldeAbsence()
            ...
            .fullPay(DEFAULT_FULL_PAY)
            .halfPay(DEFAULT_HALF_PAY)
            .util(DEFAULT_UTIL)
    ...
    public static SoldeAbsence createUpdatedEntity(EntityManager em) {
        SoldeAbsence soldeAbsence = new SoldeAbsence()
            ...
            .fullPay(UPDATED_FULL_PAY)
            .halfPay(UPDATED_HALF_PAY)
            .util(UPDATED_UTIL)
    ...
    void createSoldeAbsence() throws Exception {
        ...
        assertThat(testSoldeAbsence.getFullPayRight()).isEqualTo(DEFAULT_FULL_PAY_RIGHT);
        assertThat(testSoldeAbsence.getHalfPayRight()).isEqualTo(DEFAULT_HALF_PAY_RIGHT);
        assertThat(testSoldeAbsence.getFullPay()).isEqualTo(DEFAULT_FULL_PAY);
        assertThat(testSoldeAbsence.getHalfPay()).isEqualTo(DEFAULT_HALF_PAY);
    ...
    void getAllSoldeAbsences() throws Exception {
        ...
        restSoldeAbsenceMockMvc
            ...
            .andExpect(jsonPath("$.[*].fullPay").value(hasItem(DEFAULT_FULL_PAY)))
            .andExpect(jsonPath("$.[*].halfPay").value(hasItem(DEFAULT_HALF_PAY)))
    ...
    void getSoldeAbsence() throws Exception {
        ...
        restSoldeAbsenceMockMvc
            ...
            .andExpect(jsonPath("$.fullPay").value(DEFAULT_FULL_PAY))
            .andExpect(jsonPath("$.halfPay").value(DEFAULT_HALF_PAY))
    ...
    void putNewSoldeAbsence() throws Exception {
        ...
        assertThat(testSoldeAbsence.getFullPayRight()).isEqualTo(UPDATED_FULL_PAY_RIGHT);
        assertThat(testSoldeAbsence.getHalfPayRight()).isEqualTo(UPDATED_HALF_PAY_RIGHT);
        assertThat(testSoldeAbsence.getFullPay()).isEqualTo(UPDATED_FULL_PAY);
        assertThat(testSoldeAbsence.getHalfPay()).isEqualTo(UPDATED_HALF_PAY);
    ...
    void partialUpdateSoldeAbsenceWithPatch() throws Exception {
        ...
        partialUpdatedSoldeAbsence.isDeleted(UPDATED_IS_DELETED);
