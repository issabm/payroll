...
export class PayrollUpdateComponent implements OnInit {
  ...
  protected updateForm(payroll: IPayroll): void {
    this.editForm.patchValue({
      ...
      annee: payroll.annee,
      mois: payroll.mois,
      nbFullPaie: payroll.nbFullPaie,
      nbHalfPaie: payroll.nbHalfPaie,
      nbNonPaie: payroll.nbNonPaie,
      dateCalcul: payroll.dateCalcul,
      dateValid: payroll.dateValid,
      datePayroll: payroll.datePayroll,
      totalCotis: payroll.totalCotis,
      totalRetenue: payroll.totalRetenue,
      totalTaxable: payroll.totalTaxable,
      totalTax: payroll.totalTax,
    ...
    this.employesSharedCollection = this.employeService.addEmployeToCollectionIfMissing(this.employesSharedCollection, payroll.employe);
  ...
  protected createFromForm(): IPayroll {
    return {
      ...
      nbFullPaie: this.editForm.get(['nbFullPaie'])!.value,
      nbHalfPaie: this.editForm.get(['nbHalfPaie'])!.value,
      nbNonPaie: this.editForm.get(['nbNonPaie'])!.value,
