...
describe('SoldeAbsence Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Employe query and add missing value', () => {
      ...
      const affectation: IEmploye = { id: 59996 };
      soldeAbsence.affectation = affectation;
      ...
      const additionalEmployes = [affectation];
    ...
    it('Should update editForm', () => {
      const soldeAbsence: ISoldeAbsence = { id: 456 };
      const affectation: IEmploye = { id: 22110 };
      soldeAbsence.affectation = affectation;
      ...
      expect(comp.employesSharedCollection).toContain(affectation);
