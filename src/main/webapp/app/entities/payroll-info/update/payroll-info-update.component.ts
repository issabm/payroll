...
export class PayrollInfoUpdateComponent implements OnInit {
  ...
  protected updateForm(payrollInfo: IPayrollInfo): void {
    this.editForm.patchValue({
      ...
      calculVal: payrollInfo.calculVal,
      effectVal: payrollInfo.effectVal,
      tauxAbs: payrollInfo.tauxAbs,
      finalVal: payrollInfo.finalVal,
      effectValDevise: payrollInfo.effectValDevise,
  ...
  protected createFromForm(): IPayrollInfo {
    return {
      ...
      calculVal: this.editForm.get(['calculVal'])!.value,
      effectVal: this.editForm.get(['effectVal'])!.value,
      tauxAbs: this.editForm.get(['tauxAbs'])!.value,
      finalVal: this.editForm.get(['finalVal'])!.value,
      effectValDevise: this.editForm.get(['effectValDevise'])!.value,
