...
public class SoldeAbsencePaie implements Serializable {
    ...
    public SoldeAbsencePaie fullPayRight(Integer fullPayRight) {
    ...
    public SoldeAbsencePaie halfPayRight(Integer halfPayRight) {
    ...
    public SoldeAbsencePaie fullPay(Integer fullPay) {
    ...
    public SoldeAbsencePaie halfPay(Integer halfPay) {
