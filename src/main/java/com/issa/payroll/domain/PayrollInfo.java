...
public class PayrollInfo implements Serializable {
    ...
    @Column(name = "calcul_val")
    private Double calculVal;

    @Column(name = "effect_val")
    private Double effectVal;

    @Column(name = "taux_abs")
    private Double tauxAbs;

    @Column(name = "final_val")
    private Double finalVal;

    @Column(name = "effect_val_devise")
    private Double effectValDevise;
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "employe", "devise", "mvt", "situation" }, allowSetters = true)
    ...
    public Double getCalculVal() {
        return this.calculVal;
    }

    public PayrollInfo calculVal(Double calculVal) {
        this.setCalculVal(calculVal);
        return this;
    }

    public void setCalculVal(Double calculVal) {
        this.calculVal = calculVal;
    }
    ...
    public PayrollInfo effectVal(Double effectVal) {
        this.setEffectVal(effectVal);
        return this;
    }

    public void setEffectVal(Double effectVal) {
        this.effectVal = effectVal;
    }

    public Double getTauxAbs() {
        return this.tauxAbs;
    }

    public PayrollInfo tauxAbs(Double tauxAbs) {
        this.setTauxAbs(tauxAbs);
        return this;
    }

    public void setTauxAbs(Double tauxAbs) {
        this.tauxAbs = tauxAbs;
    }
    ...
    public PayrollInfo finalVal(Double finalVal) {
        this.setFinalVal(finalVal);
        return this;
    }
    ...
    public Double getEffectValDevise() {
        return this.effectValDevise;
    }

    public PayrollInfo effectValDevise(Double effectValDevise) {
        this.setEffectValDevise(effectValDevise);
        return this;
    }

    public void setEffectValDevise(Double effectValDevise) {
        this.effectValDevise = effectValDevise;
    }
    ...
    public String toString() {
        return "PayrollInfo{" +
            ...
            ", libAr='" + getLibAr() + "'" +
            ", libEr='" + getLibEr() + "'" +
            ", calculVal=" + getCalculVal() +
            ", effectVal=" + getEffectVal() +
            ", tauxAbs=" + getTauxAbs() +
            ", finalVal=" + getFinalVal() +
            ", effectValDevise=" + getEffectValDevise() +
