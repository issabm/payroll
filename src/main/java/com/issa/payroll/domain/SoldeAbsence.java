...
public class SoldeAbsence implements Serializable {
    ...
    public SoldeAbsence fullPayRight(Integer fullPayRight) {
    ...
    public SoldeAbsence halfPayRight(Integer halfPayRight) {
    ...
    public SoldeAbsence fullPay(Integer fullPay) {
    ...
    public SoldeAbsence halfPay(Integer halfPay) {
    ...
    public Employe getAffectation() {
        return this.affectation;
    }

    public void setAffectation(Employe employe) {
        this.affectation = employe;
    }

    public SoldeAbsence affectation(Employe employe) {
        this.setAffectation(employe);
        return this;
    }
