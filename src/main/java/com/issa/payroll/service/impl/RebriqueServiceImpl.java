    ...
    public Optional<Rebrique> partialUpdate(Rebrique rebrique) {
        ...
        return rebriqueRepository
            ...
            .map(existingRebrique -> {
                ...
                if (rebrique.getInSocial() != null) {
                    existingRebrique.setInSocial(rebrique.getInSocial());
                }
                if (rebrique.getInBp() != null) {
                    existingRebrique.setInBp(rebrique.getInBp());
                }
                if (rebrique.getVal() != null) {
                    existingRebrique.setVal(rebrique.getVal());
                }
