    ...
    public Optional<SoldeAbsencePaie> partialUpdate(SoldeAbsencePaie soldeAbsencePaie) {
        ...
        return soldeAbsencePaieRepository
            ...
            .map(existingSoldeAbsencePaie -> {
                ...
                if (soldeAbsencePaie.getFullPayRight() != null) {
                    existingSoldeAbsencePaie.setFullPayRight(soldeAbsencePaie.getFullPayRight());
                }
                if (soldeAbsencePaie.getHalfPayRight() != null) {
                    existingSoldeAbsencePaie.setHalfPayRight(soldeAbsencePaie.getHalfPayRight());
                }
                if (soldeAbsencePaie.getFullPay() != null) {
                    existingSoldeAbsencePaie.setFullPay(soldeAbsencePaie.getFullPay());
                }
                if (soldeAbsencePaie.getHalfPay() != null) {
                    existingSoldeAbsencePaie.setHalfPay(soldeAbsencePaie.getHalfPay());
                }
