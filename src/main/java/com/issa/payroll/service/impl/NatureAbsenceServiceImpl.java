    ...
    public Optional<NatureAbsence> partialUpdate(NatureAbsence natureAbsence) {
        ...
        return natureAbsenceRepository
            ...
            .map(existingNatureAbsence -> {
                ...
                if (natureAbsence.getFullPay() != null) {
                    existingNatureAbsence.setFullPay(natureAbsence.getFullPay());
                }
                if (natureAbsence.getHalfPay() != null) {
                    existingNatureAbsence.setHalfPay(natureAbsence.getHalfPay());
                }
