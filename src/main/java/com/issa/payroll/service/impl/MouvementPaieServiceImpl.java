    ...
    public Optional<MouvementPaie> partialUpdate(MouvementPaie mouvementPaie) {
        ...
        return mouvementPaieRepository
            ...
            .map(existingMouvementPaie -> {
                ...
                if (mouvementPaie.getTotalCotis() != null) {
                    existingMouvementPaie.setTotalCotis(mouvementPaie.getTotalCotis());
                }
                if (mouvementPaie.getTotalRetenue() != null) {
                    existingMouvementPaie.setTotalRetenue(mouvementPaie.getTotalRetenue());
                }
                if (mouvementPaie.getTotalTaxable() != null) {
                    existingMouvementPaie.setTotalTaxable(mouvementPaie.getTotalTaxable());
                }
                if (mouvementPaie.getTotalTax() != null) {
                    existingMouvementPaie.setTotalTax(mouvementPaie.getTotalTax());
                }
