    ...
    public Optional<Payroll> partialUpdate(Payroll payroll) {
        ...
        return payrollRepository
            ...
            .map(existingPayroll -> {
                ...
                if (payroll.getNbFullPaie() != null) {
                    existingPayroll.setNbFullPaie(payroll.getNbFullPaie());
                }
                if (payroll.getNbHalfPaie() != null) {
                    existingPayroll.setNbHalfPaie(payroll.getNbHalfPaie());
                }
                if (payroll.getNbNonPaie() != null) {
                    existingPayroll.setNbNonPaie(payroll.getNbNonPaie());
                }
                ...
                if (payroll.getTotalCotis() != null) {
                    existingPayroll.setTotalCotis(payroll.getTotalCotis());
                }
                if (payroll.getTotalRetenue() != null) {
                    existingPayroll.setTotalRetenue(payroll.getTotalRetenue());
                }
                if (payroll.getTotalTaxable() != null) {
                    existingPayroll.setTotalTaxable(payroll.getTotalTaxable());
                }
                if (payroll.getTotalTax() != null) {
                    existingPayroll.setTotalTax(payroll.getTotalTax());
                }
