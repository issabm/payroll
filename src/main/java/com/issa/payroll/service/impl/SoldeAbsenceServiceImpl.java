    ...
    public Optional<SoldeAbsence> partialUpdate(SoldeAbsence soldeAbsence) {
        ...
        return soldeAbsenceRepository
            ...
            .map(existingSoldeAbsence -> {
                ...
                if (soldeAbsence.getFullPayRight() != null) {
                    existingSoldeAbsence.setFullPayRight(soldeAbsence.getFullPayRight());
                }
                if (soldeAbsence.getHalfPayRight() != null) {
                    existingSoldeAbsence.setHalfPayRight(soldeAbsence.getHalfPayRight());
                }
                if (soldeAbsence.getFullPay() != null) {
                    existingSoldeAbsence.setFullPay(soldeAbsence.getFullPay());
                }
                if (soldeAbsence.getHalfPay() != null) {
                    existingSoldeAbsence.setHalfPay(soldeAbsence.getHalfPay());
                }
