    ...
    public Optional<PayrollInfo> partialUpdate(PayrollInfo payrollInfo) {
        ...
        return payrollInfoRepository
            ...
            .map(existingPayrollInfo -> {
                ...
                if (payrollInfo.getCalculVal() != null) {
                    existingPayrollInfo.setCalculVal(payrollInfo.getCalculVal());
                }
                if (payrollInfo.getEffectVal() != null) {
                    existingPayrollInfo.setEffectVal(payrollInfo.getEffectVal());
                }
                if (payrollInfo.getTauxAbs() != null) {
                    existingPayrollInfo.setTauxAbs(payrollInfo.getTauxAbs());
                }
                if (payrollInfo.getFinalVal() != null) {
                    existingPayrollInfo.setFinalVal(payrollInfo.getFinalVal());
                }
                if (payrollInfo.getEffectValDevise() != null) {
                    existingPayrollInfo.setEffectValDevise(payrollInfo.getEffectValDevise());
                }
