...
public class EchlonResource {
    ...
    public ResponseEntity<Echlon> updateEchlon(@PathVariable(value = "id", required = false) final Long id, @RequestBody Echlon echlon)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, echlon.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Echlon> partialUpdateEchlon(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, echlon.getId().toString())
        );
    }
