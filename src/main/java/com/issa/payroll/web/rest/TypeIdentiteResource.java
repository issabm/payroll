...
public class TypeIdentiteResource {
    ...
    public ResponseEntity<TypeIdentite> updateTypeIdentite(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeIdentite.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TypeIdentite> partialUpdateTypeIdentite(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeIdentite.getId().toString())
        );
    }
