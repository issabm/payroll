...
public class DeviseResource {
    ...
    public ResponseEntity<Devise> updateDevise(@PathVariable(value = "id", required = false) final Long id, @RequestBody Devise devise)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, devise.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Devise> partialUpdateDevise(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, devise.getId().toString())
        );
    }
