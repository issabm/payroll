...
public class FrequenceResource {
    ...
    public ResponseEntity<Frequence> updateFrequence(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, frequence.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Frequence> partialUpdateFrequence(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, frequence.getId().toString())
        );
    }
