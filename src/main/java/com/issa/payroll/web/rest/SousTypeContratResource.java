...
public class SousTypeContratResource {
    ...
    public ResponseEntity<SousTypeContrat> updateSousTypeContrat(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sousTypeContrat.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SousTypeContrat> partialUpdateSousTypeContrat(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sousTypeContrat.getId().toString())
        );
    }
