...
public class PayrollInfoResource {
    ...
    public ResponseEntity<PayrollInfo> updatePayrollInfo(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, payrollInfo.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PayrollInfo> partialUpdatePayrollInfo(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, payrollInfo.getId().toString())
        );
    }
