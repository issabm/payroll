...
public class EmploiResource {
    ...
    public ResponseEntity<Emploi> updateEmploi(@PathVariable(value = "id", required = false) final Long id, @RequestBody Emploi emploi)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, emploi.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Emploi> partialUpdateEmploi(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, emploi.getId().toString())
        );
    }
