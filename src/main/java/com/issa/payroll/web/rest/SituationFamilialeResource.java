...
public class SituationFamilialeResource {
    ...
    public ResponseEntity<SituationFamiliale> updateSituationFamiliale(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, situationFamiliale.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SituationFamiliale> partialUpdateSituationFamiliale(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, situationFamiliale.getId().toString())
        );
    }
