...
public class ConjointResource {
    ...
    public ResponseEntity<Conjoint> updateConjoint(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, conjoint.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Conjoint> partialUpdateConjoint(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, conjoint.getId().toString())
        );
    }
