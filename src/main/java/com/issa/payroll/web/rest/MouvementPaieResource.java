...
public class MouvementPaieResource {
    ...
    public ResponseEntity<MouvementPaie> updateMouvementPaie(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, mouvementPaie.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<MouvementPaie> partialUpdateMouvementPaie(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, mouvementPaie.getId().toString())
        );
    }
