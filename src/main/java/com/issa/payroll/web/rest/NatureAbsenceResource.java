...
public class NatureAbsenceResource {
    ...
    public ResponseEntity<NatureAbsence> updateNatureAbsence(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, natureAbsence.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<NatureAbsence> partialUpdateNatureAbsence(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, natureAbsence.getId().toString())
        );
    }
