...
public class SoldeAbsencePaieResource {
    ...
    public ResponseEntity<SoldeAbsencePaie> updateSoldeAbsencePaie(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, soldeAbsencePaie.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SoldeAbsencePaie> partialUpdateSoldeAbsencePaie(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, soldeAbsencePaie.getId().toString())
        );
    }
