...
public class ModeCalculResource {
    ...
    public ResponseEntity<ModeCalcul> updateModeCalcul(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, modeCalcul.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ModeCalcul> partialUpdateModeCalcul(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, modeCalcul.getId().toString())
        );
    }
