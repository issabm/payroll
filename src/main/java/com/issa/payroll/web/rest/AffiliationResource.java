...
public class AffiliationResource {
    ...
    public ResponseEntity<Affiliation> updateAffiliation(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, affiliation.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Affiliation> partialUpdateAffiliation(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, affiliation.getId().toString())
        );
    }
