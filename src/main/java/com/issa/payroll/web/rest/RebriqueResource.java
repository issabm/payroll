...
public class RebriqueResource {
    ...
    public ResponseEntity<Rebrique> updateRebrique(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, rebrique.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Rebrique> partialUpdateRebrique(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, rebrique.getId().toString())
        );
    }
