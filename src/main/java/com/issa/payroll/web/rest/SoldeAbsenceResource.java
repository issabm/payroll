...
public class SoldeAbsenceResource {
    ...
    public ResponseEntity<SoldeAbsence> updateSoldeAbsence(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, soldeAbsence.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SoldeAbsence> partialUpdateSoldeAbsence(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, soldeAbsence.getId().toString())
        );
    }
