...
public class TypeHandicapResource {
    ...
    public ResponseEntity<TypeHandicap> updateTypeHandicap(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeHandicap.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TypeHandicap> partialUpdateTypeHandicap(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeHandicap.getId().toString())
        );
    }
