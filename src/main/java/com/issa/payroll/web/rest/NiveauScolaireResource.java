...
public class NiveauScolaireResource {
    ...
    public ResponseEntity<NiveauScolaire> updateNiveauScolaire(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, niveauScolaire.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<NiveauScolaire> partialUpdateNiveauScolaire(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, niveauScolaire.getId().toString())
        );
    }
