...
public class EntityAdhesionResource {
    ...
    public ResponseEntity<EntityAdhesion> updateEntityAdhesion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, entityAdhesion.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<EntityAdhesion> partialUpdateEntityAdhesion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, entityAdhesion.getId().toString())
        );
    }
