...
public class ConcerneResource {
    ...
    public ResponseEntity<Concerne> updateConcerne(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, concerne.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Concerne> partialUpdateConcerne(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, concerne.getId().toString())
        );
    }
