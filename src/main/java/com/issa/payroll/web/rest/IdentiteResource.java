...
public class IdentiteResource {
    ...
    public ResponseEntity<Identite> updateIdentite(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, identite.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Identite> partialUpdateIdentite(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, identite.getId().toString())
        );
    }
