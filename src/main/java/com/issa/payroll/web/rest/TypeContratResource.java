...
public class TypeContratResource {
    ...
    public ResponseEntity<TypeContrat> updateTypeContrat(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeContrat.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TypeContrat> partialUpdateTypeContrat(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, typeContrat.getId().toString())
        );
    }
