...
public class NatureAdhesionResource {
    ...
    public ResponseEntity<NatureAdhesion> updateNatureAdhesion(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, natureAdhesion.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<NatureAdhesion> partialUpdateNatureAdhesion(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, natureAdhesion.getId().toString())
        );
    }
